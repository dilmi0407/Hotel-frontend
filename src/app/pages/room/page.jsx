        ...
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-10 p-10">
          ...
          <section className="text-center md:text-left space-y-6">
            ...
            <p className="text-2xl font-serif text-black leading-relaxed">
              Experience comfort and elegance in our Deluxe Rooms. These spacious accommodations feature stylish interiors, premium bedding, a mini-fridge, complimentary Wi-Fi, and a private balcony with scenic views — perfect for guests seeking both luxury and relaxation.
            </p>
